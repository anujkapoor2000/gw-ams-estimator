...
function Section({ title, icon, children, accent }) {
  ...
  return (
    <div className="section-card" style={{
      ...
      <div style={{
        background: `linear-gradient(100deg, ${bg} 0%, ${bg}CC 100%)`,
        padding: "15px 22px", display: "flex", alignItems: "center", gap: 12
      }}>
        <span style={{
...
function KPI({ label, value, sub, color }) {
  return (
    <div className="kpi-card" style={{
      ...
      borderTop: "4px solid " + (color || C.blue),
      flex: 1, minWidth: 150,
  ...
  return (
    <div style={{ overflowX: "auto", borderRadius: 8, border: "1px solid #E8EDF5" }}>
      <table className="data-table" style={{
        ...
        fontSize: compact ? 12 : 13, fontFamily: "'Barlow', sans-serif"
      }}>
        <thead>
          <tr>
            {headers.map((h, i) => (
    ...
    <div style={{ marginBottom: 20 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 7 }}>
        ...
        <span style={{
          ...
          fontFamily: "'Barlow Condensed', sans-serif",
          background: C.blue + "12", padding: "2px 11px", borderRadius: 6
        }}>{value}{unit}</span>
      </div>
      <input
        ...
        style={{
          ...
          background: `linear-gradient(to right, ${C.blue} ${pct}%, #E2E8F0 ${pct}%)`
        }}
      />
...
export default function App() {
  ...
  return (
    <div style={{ fontFamily: "'Barlow', sans-serif", background: "#F0F4FA", minHeight: "100vh", color: C.darkGray }}>
      ...
      {/* Main header */}
      <div style={{
        background: "linear-gradient(135deg, #001A4E 0%, #003087 55%, #0057A8 100%)",
        padding: "30px 36px 26px",
        boxShadow: "0 4px 28px rgba(0,26,78,0.32)",
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 20, position: "relative" }}>
          <div>
            ...
            }}>Guidewire Cloud AMS</div>
            <div style={{
              color: "#93C5FD", fontSize: 16, fontWeight: 600,
              fontFamily: "'Barlow Condensed', sans-serif",
              letterSpacing: "0.05em", marginBottom: 8
            }}>Engagement Estimator</div>
            <div style={{ color: "rgba(147,197,253,0.75)", fontSize: 11, letterSpacing: "0.05em" }}>
              PC · CC · BC · Digital (Jutro) · L2/L3 · Enhancements · 3-Year Plan · AI-Augmented
            </div>
          </div>

          <div style={{ textAlign: "right" }}>
            <div style={{
              color: "rgba(147,197,253,0.75)", fontSize: 10,
              textTransform: "uppercase", letterSpacing: "0.12em", marginBottom: 5
            }}>3-Year Programme Cost</div>
            <div style={{
              color: C.white, fontSize: 40, fontWeight: 800,
              fontFamily: "'Barlow Condensed', sans-serif", lineHeight: 1
            }}>{currSymbol}{(totalProgramCost / 1000000).toFixed(2)}M</div>
            <div style={{
              color: "rgba(147,197,253,0.75)", fontSize: 11, marginTop: 7,
              ...
              <span style={{ opacity: 0.5 }}>·</span>
              <span>{selectedIntegrations.length} integrations</span>
            </div>
          </div>
        </div>
      </div>
        ...
        {TABS.map((t) => (
          <button
            ...
            style={{
              ...
              background: activeTab === t.id ? "#EEF4FF" : "transparent",
      ...
      {/* Export Toolbar */}
      <div style={{
        background: "#FAFBFE", borderBottom: "1px solid #E2E8F0",
        padding: "10px 28px", display: "flex", alignItems: "center",
        justifyContent: "flex-end", gap: 10
      }}>
        <span style={{ fontSize: 11, color: C.mid, fontFamily: "'Barlow', sans-serif", marginRight: 4 }}>
          Export estimates as:
        </span>
        <button
          ...
          style={{
            ...
            boxShadow: "0 2px 10px rgba(228,0,43,0.28)"
          }}
        >
        ...
        <button
          ...
          style={{
            ...
            boxShadow: "0 2px 10px rgba(0,48,135,0.28)"
          }}
        >
                      ...
                      {["USD","GBP"].map((c) => (
                        <button
                          ...
                          style={{
                            ...
                            border: "2px solid " + (currency === c ? C.blue : "#CBD5E0"),
                            background: currency === c ? C.blue : "white",
                            color: currency === c ? "white" : C.mid,
                            fontWeight: 700, cursor: "pointer", fontSize: 13,
                            boxShadow: currency === c ? "0 2px 8px rgba(0,48,135,0.2)" : "none"
                          }}
                        >{c}</button>
                      ))}
                    </div>
            ...
            <Section title="Enhancement Delivery Model" icon="🚀" accent={C.green}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
                ...
                <div style={{ background: "#F7FAFF", borderRadius: 10, padding: "18px 16px", border: "1px solid #E2E8F0" }}>
                  ...
                  {[
                    { size:"XS", sp:"1-2", desc:"Config tweak, label change, minor UI" },
                    { size:"S",  sp:"3-5", desc:"Validation rule, simple workflow step" },
                    { size:"M",  sp:"6-10", desc:"New screen/section, API integration field" },
                    { size:"L",  sp:"13-20", desc:"New business rule, complex workflow" },
                    { size:"XL", sp:"21+", desc:"Epic-level — split before sprint entry" },
                  ].map((r) => (
                    <div key={r.size} style={{ display: "flex", gap: 12, marginBottom: 10, alignItems: "flex-start" }}>
                      ...
                      <div style={{ fontSize: 12 }}>
                        <span style={{ fontWeight: 700, color: C.blue }}>{r.sp} SP</span>
          ...
          <div className="fade-in">
            <Section title="SLA Framework — Priority Matrix" icon="⚖️" accent={C.red}>
              ...
              <div style={{ marginTop: 18, background: "#FFF7ED", border: "1px solid #FED7AA", borderRadius: 10, padding: 16 }}>
                <div style={{ fontWeight: 700, color: C.amber, fontSize: 12, marginBottom: 8, display: "flex", alignItems: "center", gap: 6 }}>
                  <span>⚠️</span> Credit and Penalty Framework Rules
                </div>
          ...
          <div className="fade-in">
            ...
            <Section title="AI Accelerator Roadmap for AMS" icon="🤖">
              {[
                ...
                <div key={ai.name} className="ai-card" style={{
                  border: "1px solid " + ai.color + "28",
                  borderLeft: "5px solid " + ai.color,
                  borderRadius: 10, padding: "18px 18px",
                  marginBottom: 14,
                  background: ai.color + "05"
                }}>
                  ...
                  <div style={{ fontSize: 12, color: ai.color, fontWeight: 600, display: "flex", gap: 6, alignItems: "flex-start" }}>
                    <span style={{ opacity: 0.7 }}>✓</span> {ai.benefit}
                  </div>
                </div>
              ))}
            </Section>
          ...
          <div className="fade-in">
            <Section title={"Knowledge Transition Plan — " + ktMonths + "-Month Programme"} icon="🔄">
              <div style={{ marginBottom: 18, background: "#EFF6FF", border: "1px solid #BFDBFE", borderRadius: 10, padding: 16 }}>
                <div style={{ fontWeight: 700, color: C.blue, fontSize: 12, marginBottom: 6, display: "flex", alignItems: "center", gap: 6 }}>
                  <span>ℹ️</span> KT Guiding Principles
                </div>
                <div style={{ fontSize: 12, color: C.darkGray, lineHeight: 1.8 }}>
            ...
            <Section title={"Calibration Period — " + calMonths + " Months Post-KT"} icon="🎯" accent={C.navy}>
              <div style={{ background: "#F0FFF4", border: "1px solid #86EFAC", borderRadius: 10, padding: 16, marginBottom: 18 }}>
                <div style={{ fontWeight: 700, color: C.green, fontSize: 12, marginBottom: 6, display: "flex", alignItems: "center", gap: 6 }}>
                  <span>✅</span> Calibration Rules
                </div>
                <div style={{ fontSize: 12, color: C.darkGray, lineHeight: 1.8 }}>
